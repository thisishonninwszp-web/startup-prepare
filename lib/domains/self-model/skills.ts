...
export const SKILL_DEFS: SkillDef[] = [
  ...
  // ---------------- 进阶：站在基础之上，有分叉 ----------------
  { key: "rhetoric", name: "修辞", group: "express", main: "CHA", requires: ["writing"] },
  { key: "structure", name: "谋篇", group: "express", main: "CHA", requires: ["writing", "explaining"] },
  { key: "narrative", name: "叙事", group: "express", main: "CHA", requires: ["rhetoric", "structure"] },
  { key: "teachingwrite", name: "教化", group: "express", main: "CHA", requires: ["structure", "explaining"] },
  { key: "architecture", name: "构架", group: "make", main: "DEX", requires: ["coding", "productdesign"] },
  { key: "performance", name: "调优", group: "make", main: "DEX", requires: ["coding", "debugging"] },
  { key: "systemcraft", name: "造系统", group: "make", main: "DEX", requires: ["architecture", "automation"] },
  { key: "dataplumb", name: "理数", group: "make", main: "INT", requires: ["coding", "analysis"] },
  { key: "probing", name: "追问", group: "info", main: "WIS", requires: ["asking", "listening"] },
  { key: "profiling", name: "侧写", group: "info", main: "WIS", requires: ["observing", "probing"] },
  { key: "synthesis", name: "归纳", group: "info", main: "INT", requires: ["analysis", "research"] },
  { key: "cashflow", name: "现金流", group: "run", main: "RES", requires: ["finance"] },
  { key: "uniteconomics", name: "单位经济", group: "run", main: "RES", requires: ["pricing", "finance"] },
  { key: "channel", name: "渠道", group: "run", main: "RES", requires: ["recon", "partnering"] },
  { key: "mentoring", name: "带人", group: "relate", main: "CHA", requires: ["feedback", "delegating"] },
  { key: "mediating", name: "斡旋", group: "relate", main: "CHA", requires: ["conflict", "listening"] },
  { key: "metacog", name: "自省", group: "self", main: "WIS", requires: ["retro", "recovery"] },
  { key: "focuscraft", name: "凝神", group: "self", main: "WIL", requires: ["scheduling", "recovery"] },
];
